    ...
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @endforeach
                    ...
                    <a href="/tickets/{{ $match->id }}/edit" class="w-[10rem] bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 text-center block flex items-center justify-center">
                    ...
                    <form action="{{route('tickets.destroy',$match->id)}}" method="POST">
                        @csrf
                        @method('DELETE') 
                        <button type="submit" href="#" class="w-[10rem] bg-red-600 text-white py-2 rounded-lg hover:bg-red-700 text-center block flex items-center justify-center w-[10rem]" style="width: 10rem">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
