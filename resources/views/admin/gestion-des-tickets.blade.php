  ...
  <main class="ml-64 pt-20 p-8">
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow p-4 flex flex-wrap gap-4">
            ...
            <button class="bg-green-600 hover:bg-green-700 text-white px-6 py-4 rounded-lg shadow-lg transition-colors duration-200 flex items-center gap-2 w-full md:w-auto justify-center">
